    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
              ...
              setNameValue(userProfile[0].name)
              setEmailValue(userProfile[0].email)
              setAddressValue(userProfile[0].address)
    ...
    return (
        <div className="profile-container">
            ...
            <div className="password-group">
                ...
                <div className="save-button" onClick={()=>{handleUserChange(
                    { name:inputNameValue,
